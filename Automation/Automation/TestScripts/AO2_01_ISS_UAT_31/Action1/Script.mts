...
TestScriptName = "AO2_01_ISS_UAT_31"
...
Call SVOSValidate(strUsername,strPassword,stremailID)
...
'LoadFunctionLibrary "C:\OnStack_InStoreSales\FunctionLibrary\CommonFunctionsNCOwn.qfl"

'Repositoriescollection.Add "C:\OnStack_InStoreSales\Automation\ObjectRepository\SVOSRepo.tsr"

'Call SVOSStatusCheck("evoloadtest012","Spring2021!","email31verif98778@pmshelf.com")

'
'Browser("Browser").Page("CSR Desktop").WebCheckBox("Order #NC115326").Set "ON"
'
'MSGBOX "ABC"
'
