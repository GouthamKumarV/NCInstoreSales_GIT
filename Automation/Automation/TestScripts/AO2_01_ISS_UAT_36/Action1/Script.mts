...
TestScriptName = "AO2_01_ISS_UAT_36"
...
Else
	...
	For i = 1 To 4
			...
			If i=1 Then
				strXstoreUsername = "100"
				strXstorePassword = "1234"
				Call LoginXstore(LoginType,strXstoreUsername,strXstorePassword)
				Call Logout(LoginType)
			End If
	
			If i=2 Then
				strXstoreUsername = "091910053"
				strXstorePassword = "Test@1234"
				Call LoginXstore(LoginType,strXstoreUsername,strXstorePassword)
				Call Logout(LoginType)
			End If
			
			If i=3 Then
				strXstoreUsername = "091910054"
				strXstorePassword = "Test@1234"
				Call LoginXstore(LoginType,strXstoreUsername,strXstorePassword)
				Call Logout(LoginType)
			End If
