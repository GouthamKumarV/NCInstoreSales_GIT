...
TestScriptName = "AO2_01_ISS_UAT_100"
...
Wait 2
Call FinalCheckXstoreValidation()

Function FinalCheckXstoreValidation()
	...
	If JavaWindow("Oracle Retail Xstore Point").JavaEdit("Address").Exist Then
		If JavaWindow("Oracle Retail Xstore Point").JavaEdit("Address").GetROProperty("enabled")=0 Then
			Reporter.ReportEvent micPass,"Address Button Validation", "Address Button is not able to edit"
		Else
			Reporter.ReportEvent micFail,"Address Button Validation", "Address Button is able to edit so test failed"
		End If
	End If
	
	If JavaWindow("Oracle Retail Xstore Point").JavaEdit("PosTextField").Exist Then
		If JavaWindow("Oracle Retail Xstore Point").JavaEdit("PosTextField").GetROProperty("enabled")=0 Then
			Reporter.ReportEvent micPass,"First Name Button Validation", "First Name Button is not able to edit"
		Else
			Reporter.ReportEvent micFail,"First Name Button Validation", "First Name Button is able to edit so test failed"
		End If
	End If
	
	If JavaWindow("Oracle Retail Xstore Point").JavaEdit("PosTextField_2").Exist Then
		If JavaWindow("Oracle Retail Xstore Point").JavaEdit("PosTextField_2").GetROProperty("enabled")=0 Then
			Reporter.ReportEvent micPass,"First Name Button Validation", "First Name Button is not able to edit"
		Else
			Reporter.ReportEvent micFail,"First Name Button Validation", "First Name Button is able to edit so test failed"
		End If
