...
DataFilePath = "C:\NCInstoreSales\Automation\TestData\InStoreSales.xls"
...
Function FinalorderStatusValidation()
	...
	If Browser("Evolution").exist(2) Then
		...
		If 	Browser("Browser").Page("Page").Frame("Frame").WebButton("Update transaction status").Exist(3) Then
			Browser("Browser").Page("Page").Frame("Frame").WebButton("Update transaction status").Click
		End If
		
		wait 10
		If Browser("Browser").Page("Page").Frame("Frame").WebElement("Order complete").Exist(5) Then
			Validationtext =  Browser("Browser").Page("Page").Frame("Frame").WebElement("Order complete").GetROProperty("text")
